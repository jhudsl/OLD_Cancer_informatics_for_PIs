...
The curriculum will cover the roles and responsibilities of a PI in collaborative, mentor, or employer relationships with informatics experts. It will cover budgeting for cancer informatics locally or on the cloud. The course will also cover key responsibilities for lab leaders (including PIs and staff) in data security, privacy, management and reproducibility.  
