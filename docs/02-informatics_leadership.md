...
Having an awareness for the **specific challenges** that your informatics collaborators, employees, and mentees will face and how you as a research leader can help will not only improve their work environment, but it will improve the potential impact of your work.

2. **Perform informatics research well**

Particularly in informatics research, we need to be mindful of making mistakes or accidentally (or intentionally):

> Fudging things to find things.

We will describe some best practices to get the most out of your informatics projects. 
